<br>
<p><a href="<?=base_url('keluar');?>"><button type="button" class="btn btn-primary">Kembali ke Daftar Pengeluaran</button></a></p>
...
<?php } ?>
<form action="<?=base_url('keluar/update_pengeluaran');?>" method="POST">
