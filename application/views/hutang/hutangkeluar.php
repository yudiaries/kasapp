<h4>Tambah hutang</h4>
	...
	<?php } ?>
<a href="<?=base_url('hutang');?>"><button type="button" class="btn btn-primary">Kembali ke Daftar Hutang</button></a>
<form action="<?=base_url('hutang/tambah_hutangkeluar');?>" method="POST">
