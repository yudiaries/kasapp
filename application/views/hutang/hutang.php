...
<table class="table table-hover">
	...
	?>
		<tr>
			<th colspan="3" scope="col">TOTAL <small>(hutang)</small></th>
			<th>
			</th>
...
<p><a href="<?=base_url('hutang/hutangkeluar');?>"><button type="button" class="btn btn-primary">Tambah Hutang</button></a></p>
<table class="table table-hover">
	<thead class="thead-dark">
		<tr>
		<th scope="col">Nomor</th>
