<br>
<p><a href="<?=base_url('hutang');?>"><button type="button" class="btn btn-primary">Kembali ke Daftar hutangkeluar</button></a></p>
<h4>Ubah hutangkeluar</h4>
...
<?php } ?>
<form action="<?=base_url('hutang/update_hutangkeluar');?>" method="POST">
