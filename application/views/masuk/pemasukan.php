...
<h4>Tambah Pemasukan</h4>
	...
	<?php } ?>
<a href="<?=base_url('masuk');?>"><button type="button" class="btn btn-primary">Kembali ke Daftar Pemasukan</button></a>
<form action="<?=base_url('masuk/tambah_pemasukan');?>" method="POST">
	...
	<div class="form-group">
		<label class="col-form-label" for="tanggal">Tanggal Nota</label>
